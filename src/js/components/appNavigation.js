...
//   let iconHtml = "";
//   navContent.forEach((navIcon) => {
//     const icon = `<li class="listItem">
//                       <a class="menuItem" href="${navIcon.link}">
//                           ${navIcon.icon}
//                           <span class="menuItem-text smallText">${navIcon.text}</span>
//                       </a>
//                   </li>`;
...
function navComponent(elementId) {
  // const appNavigation = `
  //     <div class="container">
  ...
  const appNavigation = `
      <div class="container">
        <a href="index.html" class="logo">McCormick Family Reunion</a>
      </div>
    `;
  document.getElementById(elementId).innerHTML = appNavigation;
}
